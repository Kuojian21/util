...
public interface HelloPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        sayHello(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void sayHello(String s, java.util.Map<String, String> context)
    {
        _iceI_sayHelloAsync(s, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> sayHelloAsync(String s)
    {
        return _iceI_sayHelloAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> sayHelloAsync(String s, java.util.Map<String, String> context)
    {
        return _iceI_sayHelloAsync(s, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_sayHelloAsync(String iceP_s, java.util.Map<String, String> context, boolean sync)
    {
    ...
    {
        return "::com::test::rpc::zeroice::Hello";
    }
}
