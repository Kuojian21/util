...
import com.netease.finance.crowdfund.core.constant.CommonConstant;
...
public class Site {
    ...
    private int timeOut = CommonConstant.URL_SO_TIME_OUT;
    private int connectTimeOut = CommonConstant.URL_CONNECTION_TIME_OUT;
    ...
    public static Site createDefault() {
    	return custom().setRetryTimes(0)
    				.setUseGzip(false)
    				.setTimeOut(CommonConstant.URL_SO_TIME_OUT)
